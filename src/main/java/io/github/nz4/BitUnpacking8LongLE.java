...
final class BitUnpacking8LongLE
{
    ...
    public static void unpack(byte[] src, int srcOff, long[] dst, int dstOff, int bits)
    {
        switch (bits) {
        case 0:
            bitUnpack8LongLE0(src, srcOff, dst, dstOff);
            break;
        case 1:
    ...
    public static void bitUnpack8LongLE0(byte[] src, int srcOff, long[] dst, int dstOff)
    {
    ...
    public static void bitUnpack8LongLE0(IntToLongFunction src, int srcOff, long[] dst, int dstOff)
    {
        Arrays.fill(dst, dstOff, dstOff + 8, 0);
    }
